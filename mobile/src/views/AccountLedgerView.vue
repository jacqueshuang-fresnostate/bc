...
<template>
  <div class="account-ledger min-h-screen bg-surface pb-10 text-on-surface font-body">
    <header class="fixed top-0 left-0 z-50 w-full bg-white/85 shadow-[0_4px_40px_0_rgba(140,10,21,0.04)] backdrop-blur-md">
    ...
    <main class="mx-auto flex w-full max-w-lg flex-col gap-4 px-4 pt-20">
